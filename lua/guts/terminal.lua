-- ~/.config/nvim/lua/guts/terminal.lua
-- Terminal ANSI colors, used by :terminal buffers and any program that
-- writes ANSI escapes inside Neovim (ripgrep, git, fzf, lazygit, shells).
local M = {}
